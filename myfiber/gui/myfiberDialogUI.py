...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.api_group_2 = QtWidgets.QButtonGroup(Dialog)
        self.api_group_2.setObjectName("api_group_2")
        self.api_group_2.addButton(self.sites_radio)
        ...
        self.api_group_2.addButton(self.locations_radio)
        ...
        self.api_group_2.addButton(self.regions_radio)
